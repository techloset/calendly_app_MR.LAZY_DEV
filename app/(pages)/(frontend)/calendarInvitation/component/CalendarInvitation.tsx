          ...
          <div className="w-[600px] h-[300px] mt-10">
            ...
            <div>
              <div className="text-center flex items-center justify-center gap-2">
                ...
                <p className="text-[19px] font-semibold ">You are scheduled</p>
              </div>
            </div>
            <div>
            ...
            <div className="flex justify-center">
              <div className="w-[480px] h-[160px] mt-5 border-[1px] border-grey rounded-[8px]">
                <div className="py-3 px-5">
                  <div>
                    <p className="text-[18px] font-bold">30 Minutes Meeting</p>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <div>
                      <Image src={calendar} className="w-4 h-4" alt="Person" />
                    </div>
                    <div>
                      <p className="text-[17px] font-semibold text-gray-500">
